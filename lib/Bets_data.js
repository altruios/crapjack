...
const bets_data = [
    ...
    ["hard 12",(cs,v,p,d)=>cs.every(x=>x.value==6)&&cs.length==2,4,false,['v12','lose'],0],
    ["hard 14",(cs,v,p,d)=>cs.every(x=>x.value==7)&&cs.length==2,4,false,['v14','lose'],0],
    ["hard 16",(cs,v,p,d)=>cs.every(x=>x.value==8)&&cs.length==2,4,false,['v16','lose'],0],
    ["hard 18",(cs,v,p,d)=>cs.every(x=>x.value==9)&&cs.length==2,4,false,['v18','lose'],0],
    ["red hard 12",(cs,v,p,d)=>cs.every(x=>x.value==6)&&cs.length==2,16,true,[''],0],
    ["red hard 14",(cs,v,p,d)=>cs.every(x=>x.value==7)&&cs.length==2,16,true,[''],0],
    ["red hard 16",(cs,v,p,d)=>cs.every(x=>x.value==8)&&cs.length==2,16,true,[''],0],
    ["red hard 18",(cs,v,p,d)=>cs.every(x=>x.value==9)&&cs.length==2,16,true,[''],0],
